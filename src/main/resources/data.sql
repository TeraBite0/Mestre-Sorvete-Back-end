...
INSERT INTO RECOMENDACAO_DIA
       (FK_ID_PROD_RECO_DIA, DATA_RECO_DIA, TEXTO_RECO_DIA)
VALUES (1, '2025-02-23', 'O sorvete de Nescolak é uma delícia cremosa que combina o sabor intenso do achocolatado com a textura suave do sorvete. Ele possui uma base de creme gelado, delicadamente misturado com o inconfundível sabor do Nesquik')
